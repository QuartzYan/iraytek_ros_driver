...
enum
{
    ...
    MESSAGE_CMD_GET_WEBROMVER,              ///<获取网页(ROM)版本
    MESSAGE_CMD_FILLLIGHT_ON,               ///<补光灯开启
    MESSAGE_CMD_FILLLIGHT_OFF,              ///<补光灯关闭

	MESSAGE_CMD_GET_ONVIFPARAM,				///<onvif参数
	MESSAGE_CMD_SET_ONVIFPARAM,				///<onvif参数
	MESSAGE_CMD_GET_IMAGEFUSEPARAM_EX,		///<图像融合参数
	MESSAGE_CMD_SET_IMAGEFUSEPARAM_EX,		///<图像融合参数
		
	MESSAGE_CMD_GET_FUSEOFFSET,				///<融合偏移
	MESSAGE_CMD_SET_FUSEOFFSET,				///<融合偏移
	MESSAGE_CMD_GET_IMAGEFLIPPARAM,			///<图像翻转参数
	MESSAGE_CMD_SET_IMAGEFLIPPARAM,			///<图像翻转参数

	MESSAGE_CMD_GET_PIXLETEMPERATURE,		///<获取像素点的温度
	MESSAGE_CMD_SET_PIXLETEMPERATURE,		///<设置像素点位置

	MESSAGE_CMD_GET_POLYGONTEMPPARAM,		///<获取多边形测温多边形参数
	MESSAGE_CMD_SET_POLYGONTEMPPARAM,		///<设置多边形测温多边形参数

	MESSAGE_CMD_GET_HUMANCALIPARAM,			///<人体测温校准参数
	MESSAGE_CMD_SET_HUMANCALIPARAM,			///<人体测温校准参数

	MESSAGE_CMD_GET_TEMPSHIELDPARAM,		///<测温区屏蔽
	MESSAGE_CMD_SET_TEMPSHIELDPARAM,		///<测温区屏蔽

	MESSAGE_CMD_HUMANCALI_MANUAL,			///<人体测温校准参数手动
	MESSAGE_CMD_HUMANCALI_RESTORE,			///<人体测温校准参数恢复
	MESSAGE_CMD_GET_HUMANCALI_VISMATCHIR,	///<红外和可见光图像对应参数(可见光+参数对应红外)
	MESSAGE_CMD_SET_HUMANCALI_VISMATCHIR,	///<红外和可见光图像对应参数(可见光+参数对应红外)
	MESSAGE_CMD_GET_HUMANCALI_TEMPTABLE,	///<人体测温校准温度表
	MESSAGE_CMD_SET_HUMANCALI_TEMPTABLE,	///<人体测温校准温度表
	MESSAGE_CMD_GET_TEMPUNIT,				///<温度单位
	MESSAGE_CMD_SET_TEMPUNIT,				///<温度单位
	MESSAGE_CMD_GET_TEMPINFOLIST,			///<获取全局和区域测温温度值信息
	MESSAGE_CMD_GET_TEMPALARMCTRLEX,        ///<高温报警控制(支持4个级别)
	MESSAGE_CMD_SET_TEMPALARMCTRLEX,        ///<高温报警控制(支持4个级别)
	MESSAGE_CMD_GET_REGIONTEMPALARMCTRLEX,	///<区域温度报警控制(支持4个级别)
	MESSAGE_CMD_SET_REGIONTEMPALARMCTRLEX,	///<区域温度报警控制(支持4个级别)
 ...
 * @return TRUE表示成功，FALSE表示失败
*/
CNET_APIIMPORT BOOL  CALLINGCONVEN IRNET_ClientReadMessage(char *m_sername,char *m_url,WORD *m_port,int *m_ch,WPARAM *wParam,LPARAM *lParam);
...
* @see IRNET_ClientStart
*/
CNET_APIIMPORT BOOL CALLINGCONVEN IRNET_ClientBMPOptimize(/*LONG*/IRNETHANDLE hHandle, char const * m_filename);
